function start(){ //incio da funçao 
    $("#inicio").hide();//mensagem inicial
    //div do jogo
...
//principais variaveis do jogo Game loop...
    ...
    function colisao(){
       ...
       //colisao jogador com o inimigo1
       ...
       //colisao com jogador com o inimigo2
    ...
    function explosao1(inimigo1X, inimigo1Y){
        ...
        div.animate({width: 220, opacity: 40}, "slow");
    ...
    function explosao2(inimigo2X, inimigo2Y){
        ...
        div2.animate({width: 220, opacity: 40}, "slow");
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1>Game Over</h1><p>Sua pontuação foi: " + (pontos+salvos) + "</p>" + "<div id='reinicia'><h3>Jogar Novamente</h3> <button onClick=reiniciaJogo()>Reinicar</button></div>");
    }
